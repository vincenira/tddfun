...
// WithTimeout lets you set your own timeout for waiting for graceful shudown. By default this is set to 30 seconds (k8s' default TerminationGracePeriod).
...
/*
ListenAndServe will call the ListenAndServe function of the delegate HTTPServer you passed in at construction. On a signal
being sent to the shutdown signal provided in the constructor, it will call the server's
Shutdown method to attempt to gracefully shutdown.
*/
